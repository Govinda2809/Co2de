...
import { Sparkles, RotateCcw, Loader2, Zap, TrendingUp, BarChart3, Globe, Cpu, Play, Terminal, CheckCircle2, FileStack, FileCode, Info, Save, Copy, Check } from "lucide-react";
...
export default function AnalyzePage() {
  ...
  const handleFilesAccepted = useCallback(async (processed: { file: File, content: string }[]) => {
    ...
    try {
      ...
      // AI Context: Include info about the multi-file nature
      const aiContext = {
        ...metrics,
  ...
  const runCode = () => {
    setState(prev => ({ ...prev, isRunning: true, runResults: ["Initializing Virtualized Sandbox...", "Mapping Memory Segments..."] }));
    ...
    setTimeout(() => {
      try {
        ...
        setState(prev => ({ 
          ...prev, 
          isRunning: false, 
          runResults: [...prev.runResults, `📡 Link Established.`, `✅ Execution Successful (${duration}ms).`, ...logs] 
        }));
      } catch (e: any) {
        setState(prev => ({ 
          ...prev, 
          ...
          <div className="flex-1 space-y-12">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-[10px] font-mono text-emerald-500 uppercase tracking-[0.5em]">System.Analyze_v3.2</h2>
              </div>
        ...
        {state.metrics && state.review && !state.isAnalyzing && (
          <div className="space-y-16 animate-in fade-in slide-in-from-bottom-5 duration-1000">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-10 py-12 border-y border-white/5">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-[10px] font-mono text-gray-500 uppercase tracking-widest opacity-50">Grid: {state.metrics.gridIntensity} Intensity</p>
                </div>
              </div>
              <div className="flex flex-wrap items-center justify-center gap-4">
                <button
                  ...
                  className="flex items-center gap-4 px-10 py-4 rounded-full border border-white/10 text-white font-black hover:bg-white hover:text-black transition-all uppercase tracking-tighter disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    state.isSaved 
                      ...
                      : "bg-emerald-500 text-white hover:shadow-[0_0_30px_rgba(16,185,129,0.3)]"
                  )}
                >
            ...
            {state.runResults.length > 0 && (
              <div className="rounded-[3rem] border border-emerald-500/20 bg-emerald-500/[0.02] p-12 space-y-8 animate-in slide-in-from-top-4">
                <div className="flex items-center justify-between border-b border-emerald-500/10 pb-6">
                  <div className="flex items-center gap-4">
                    <Terminal size={14} className="text-emerald-500" />
                    <span className="text-xs font-mono uppercase tracking-[0.5em] text-emerald-500">Log.Sandbox.Trace</span>
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div className="p-12 rounded-[3.5rem] border border-white/10 bg-white/[0.02] backdrop-blur-3xl relative overflow-hidden">
                <h3 className="text-[10px] font-mono font-bold mb-12 text-gray-500 uppercase tracking-[0.5em]">Impact_Trajectory</h3>
                ...
                {!state.refactored ? (
                  ...
                  >
                    ...
                    <div className="space-y-3 relative z-10">
                      ...
                      <p className="text-emerald-500/50 text-[10px] uppercase tracking-widest font-mono">Heuristic-informed code optimization</p>
                    </div>
                   ...
                   <div className="p-10 rounded-[3.5rem] border border-emerald-500/30 bg-emerald-500/5 space-y-8 animate-in zoom-in-95">
                      ...
                      <p className="text-[13px] text-gray-400 font-medium italic leading-relaxed lowercase first-letter:uppercase pb-4">
